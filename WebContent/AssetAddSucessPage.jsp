<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="org.gk.assetmgment.dto.Assetdetail" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Asset Addition Response</title>
...
<h2>
<p align="center">
<%Assetdetail assetdetails = (Assetdetail) session.getAttribute("assetdetails"); %>
Your Asset Id is <%=assetdetails.getAssetid()%>
</p>
</h2>
</div>
